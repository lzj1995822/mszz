<template>
  <div>
      <el-row style="padding:20px;margin-top:20px">
        ...
        <el-col v-if="step==1" :span="18" style="margin-top:30px;margin-left:300px">
           <el-form :model="form" :rules="rules" ref="form" label-width="200px" label-suffix="：">
              ...
              <el-form-item label="行政区划代码" prop="regionalismCode">
                <el-input style="width:300px" v-model="form.regionalismCode"></el-input>
              </el-form-item>
        ...
        <el-col v-else-if="step==2" style="margin-top:30px;" :span="18">
          <div style="margin-left:25%">
            ...
            <el-upload
              class="upload-demo"
              :action="getDomain()+'/msmis/api/Nonpublic/uploadEnterprisePicture?code='+form.enterpriseUSCcode"
...
export default {
  ...
  mounted() {
    ...
    if (type == 1) {
      this.mytype = 1;
      this.form.isLogisticsEnterprise = 1;
      this.form.isKeyEnterprise = null;
    } else {
      this.mytype = 0;
      this.form.isKeyEnterprise = 1;
      this.form.isLogisticsEnterprise = null;
    }
...
// WEBPACK FOOTER //
// src/views/publicSecurityManage/addCompany.vue?0d11c709