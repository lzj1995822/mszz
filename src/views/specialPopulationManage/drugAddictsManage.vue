      ...
      <el-tab-pane label="数据统计" name="sjtj">
        <el-row>
          <el-col :span="18">
            ...
            <div align="center" id="histogram" style="width:100%; height:700px;margin-top:20px"></div>
          </el-col>
          <el-col :span="6">
            <div class="tjInfo">
            ...
            <el-row>
              ...
              <el-col :span="16">
                <div align="right">
                  ...
                  <el-button type="primary" @click="getdrugAddictsPerson">查询</el-button>
    ...
    methods: {
      ...
      deleteById(id) {
        this.$confirm("是否删除此人记录, 是否继续?", "提示", {
          ...
          .then(() => {
            api.deleteSpecialPerson(id, "04").then(res => {
              if (res.data) {
                this.$message({
                  type: "success",
                  message: "删除成功!"
      ...
      getdrugAddictsPerson() {
        api.fetchDrugAddictsPerson(this.filters).then(res => {
      ...
      initChart() {
        api.getSpecialPersonPieChart("04").then(res => {
          this.myobj = res.data;
          this.drawHistogram(this.myobj);
        });
      // this.myobj = [{"name":"玉晨村","value":0},{"name":"后河村","value":0},{"name":"天乐村","value":0},
      // {"name":"茅山村","value":2},{"name":"墓东村","value":2},{"name":"夏林村","value":2},
      // {"name":"马埂村","value":2},{"name":"潘冲村","value":1},{"name":"上杆村","value":1},
      // {"name":"李塔村","value":2}]
      // this.drawHistogram(this.myobj);
      }
    },
...
// WEBPACK FOOTER //
// src/views/specialPopulationManage/drugAddictsManage.vue?3cf280c5