            ...
            <el-row>
              ...
              <el-col :span="16">
                <div align="right">
                  ...
                  <el-button type="primary" @click="getEmancipistPerson">查询</el-button>
    ...
    methods: {
      ...
      deleteById(id) {
        this.$confirm("是否删除此人记录, 是否继续?", "提示", {
          ...
          .then(() => {
            api.deleteSpecialPerson(id, "01").then(res => {
              if (res.data) {
                this.$message({
                  type: "success",
                  message: "删除成功!"
      ...
      editDetail(ID) {
        let that = this;
        this.$store.commit('SET_PAGE',{name:'G',index:that.filters.page});
        this.$router.push({
      ...
      getEmancipistPerson() {
        api.fetchEmancipistPerson(this.filters).then(res => {
...
// WEBPACK FOOTER //
// src/views/specialPopulationManage/emancipistManage.vue?69d6e9ae