            ...
            <el-table :data="list" border>
              ...
              <el-table-column label="操作" width="200" align="center">
                <template scope="scope">
                  <el-button
                    size="small"
                    v-if="scope.row.eventStatus=='06'||scope.row.eventStatus=='08'"
                    type="primary"
                    @click="eventReview(scope.row.disputeEventID)"
                  >审核事件</el-button>
...
// WEBPACK FOOTER //
// src/views/contradictionManage/eventReview.vue?77b2e50b