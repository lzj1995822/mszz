          ...
          <el-row>
            ...
            <el-col :span="16">
              <div align="right">
                ...
                <el-input style="width:200px" v-model="filters.certifID" width="300px" placeholder="身份证号"></el-input>
                </el-select>
                <el-button type="primary" icon="search" @click="getStayedPersonInfo">查询</el-button>
...
export default {
  ...
  methods: {
    ...
    getStayedPersonInfo() {
      ...
      this.filters.servedPersonTypeValue = "03";
    },
    // 翻页
  ...
  mounted() {
    ...
    api.getServedHistogramCount("03").then(res => {
      let cun = res.data[0];
    ...
    this.$store.commit("INIT_PAGE","E");
    this.filters.page = this.$store.getters.page['E'];
...
// WEBPACK FOOTER //
// src/views/populationManage/stayedPopulation.vue?13abe09f